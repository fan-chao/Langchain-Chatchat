...
embedding_model_dict = {
    ...
    "bge-base-zh": "/data/fc/langchain-llama2/weights/bge-base-zh",
...
llm_model_dict = {
    ...
    #Llama2-Chinese-13b-Chat知识库问答效果一般
    "Llama2-Chinese-13b-Chat": {
        "local_model_path": "/data/fc/langchain-llama2/weights/Llama2-Chinese-13b-Chat",
        "api_base_url": "http://localhost:8888/v1",  # "name"修改为fastchat服务中的"api_base_url"
        "api_key": "EMPTY"
    },

    #Chinese-Llama-2-7b知识库问答效果较差
    "Chinese-Llama-2-7b": {
        "local_model_path": "/data/fc/langchain-llama2/weights/Chinese-Llama-2-7b",
        "api_base_url": "http://localhost:8888/v1",  # "name"修改为fastchat服务中的"api_base_url"
        "api_key": "EMPTY"
    },

    #chinese-alpaca-2-13b知识库问答效果还行
    "chinese-alpac-llama-2-13b": {
        "local_model_path": "/data/fc/langchain-llama2/weights/chinese-alpac-llama-2-13b",
        "api_base_url": "http://localhost:8888/v1",  # "name"修改为fastchat服务中的"api_base_url"
        "api_key": "EMPTY"
    },
}
...
# LLM 名称
LLM_MODEL = "chinese-alpac-llama-2-13b"
...
#system prompt for chinese-alpac-llama-2-13b
...
#system prompt for Llama2-Chinese-13b-Chat
#SYSTEM_PROMPT  = "根据已知信息，简洁和专业的来回答问题。如果无法从中得到答案，请说 “根据已知信息无法回答该问题”，不允许在答案中添加编造成分，答案请使用中文。"
